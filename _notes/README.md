...
**Planning & meta docs**: [TEACHING-PLAN.md](TEACHING-PLAN.md) (full curriculum + review + detailed modules + QA + interview-breadth pack) · [BUG-HUNTING.md](BUG-HUNTING.md) (find a bug / first-PR guide + AI-assist policy) · 34-glossary.md (planned: TTFT/TPOT/goodput + key terms).
